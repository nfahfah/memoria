<template>
    ...
    >
      ...
      <div class="hero">
        ...
        <p class="subtitle">
          Doubt begins to spread throughout Memoria. As suspicions grow, every
          challenge tests not only your abilities, but also your trust in one
          another 😶‍🌫️..
        </p>
      </div>
  ...
  import trainPoint from "../assets/images/day2-trainpoint.png";
...
function scrollToTop() {
  ...
  const activities = [
    {
      time: "8.00 AM",
      title: "Reporting Time for Overnighters",
      venue: "PGP Foyer",
    },
    {
      time: "8.45 AM",
      title: "Reporting Time for Non-overnighters & Breakfast",
      venue: "Techno Edge Canteen",
    },
    {
      time: "9.30 AM",
      title: "Sharing by Dr Rafi & Academic Sharing",
      venue: "CDE LT3",
      description: "A guide on how to navigate uni life as a Malay/Muslim and a summary of important NUS platforms."
    },
    {
      time: "11.00 AM",
      title: "Faculty Sharing by Seniors",
      venue: "Engineering Seminar Rooms",
      description: "A faculty-specific sharing to equip you with sufficient knowledge to kickstart your academic journey!"
    },
    {
      time: "11.45 AM",
      title: "Day 2 Station Games Part 1",
      venue: "YIH",
      description: "Compete in inter-OG Games to earn some points and prove your innocence!"
    },
    {
      time: "1.00 PM",
      title: "Zuhr",
    ...
    {
      time: "2.45 PM",
      title: "Day 2 Station Games Part 2",
      venue: "YIH"
    },
    {
      time: "4.00 PM",
      title: "Sharing on Musollahs and Halal Food Options",
      venue: "YIH",
      description: "The information covered is included in the NUS Guide tab!"
    },
    {
      time: "4.45 PM",
      title: "Asar",
    ...
    },
    {
      time: "7.45 PM",
      title: "Wet Games",
      venue: "Astro Field @Science",
      description: "Cool off with thrilling water games where teamwork, laughter, and unforgettable memories await!"
    },
    {
      time: "9.45 PM",
      title: "Dismissal",
  ...
  .card{
      position:relative;
      background:linear-gradient(160deg, #ffffff 0%, #FDF3F8 100%);
      border-radius:20px;
      padding:28px;
      box-shadow:0 12px 26px rgba(122,46,82,.12);
      border:2px solid #C4508A;
  ...
  .timeline-item:hover .card{
      ...
      box-shadow:0 18px 34px rgba(122,46,82,.18);
  }
